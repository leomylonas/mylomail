...
/* eslint-disable */
/* tslint:disable */
import type { ProviderType, AuthState, CertificateTrustMode, InitialSyncMode, MailTransportSecurity, ImapAuthMethod, SmtpAuthMethod, ExportJobStatus, SpecialUse, CoverageStatus, Address, OutboxStatus, EventStatus, AttendeeRole, ResponseStatus, InviteResponse } from './MyloMail.Api.Domain';
