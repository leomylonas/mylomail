...
/* eslint-disable */
/* tslint:disable */
import type { ProviderType, AuthState, CertificateTrustMode, ExportJobStatus, SpecialUse, CoverageStatus, Address, OutboxStatus, EventStatus } from './MyloMail.Api.Domain';
