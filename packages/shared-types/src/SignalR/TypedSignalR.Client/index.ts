...
class IMailHub_HubProxy implements IMailHub {
    ...
    public readonly setMailboxSpecialUseOverride = async (mailboxId: string, specialUse: (SpecialUse | undefined)): Promise<void> => {
        return await this.connection.invoke("SetMailboxSpecialUseOverride", mailboxId, specialUse);
    }
    ...
    public readonly resolveNotificationNavigation = async (notificationId: string): Promise<NotificationNavigationDto> => {
        return await this.connection.invoke("ResolveNotificationNavigation", notificationId);
    }
