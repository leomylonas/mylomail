...
1. Implement Graph recurrence-master hydration and rolling delta-window rebasing; bound Graph recovery pagination and add focused fault-injection coverage, then run fresh reviews.
