...
1. Run fresh independent invariant/security reviews over the latest window, recovery, OAuth, and parser fixes; remediate any finding, then run the full check.
